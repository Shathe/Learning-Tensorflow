...
X, Y = image_preloader(train_file, image_shape=(width, height, n_classes), mode='file', categorical_labels=True, normalize=True)
testX, testY = image_preloader(test_file, image_shape=(width, height, n_classes), mode='file', categorical_labels=True, normalize=True)
